...
int main() {
    ...
    int punctuation_count = 0, total_parenthesis_count = 0, comma_count = 0, semicolon_count = 0, parenthesis_count = 0, brace_count = 0, curly_brace_count = 0, colon_count = 0;
    int operator_count = 0, arithmetic_count = 0, assign_count = 0, relational_count = 0, logical_count = 0, bitwise_count = 0, member_count = 0;
